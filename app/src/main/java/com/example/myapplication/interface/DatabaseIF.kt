...
interface DatabaseIF {
    ...
    class GetData(private val url: String, private val fragmentManager: FragmentManager, private val context: Context, private val value: () -> Unit) : AsyncTask<String, Void, String>() {
